<?php
    ...
    if(isset($_GET['type']) && $_GET['type']=="student"){
        ...
        if(isset($user->sid)){
            ...
            if(mysql_query($sql)){
                /*$success_message[] = "You have successfully verified your account, you are being redirected to <a href='signin.php'>login</a> page within 5 second"."<script>setTimeout(function(){window.location='signin.php'},5000);</script>";
                setFlashData("success_message",$success_message);*/
				echo "<script>window.location='signin.php';</script>";
				exit;
            }else{
                /*$error_message[]  = "Sorry! we could not verify your account, Please try again later. you are being redirected to <a href='signin.php'>login</a> page within 5 second"."<script>setTimeout(function(){window.location='signin.php'},5000);</script>";
                setFlashData("error_message",$error_message);*/
				echo "<script>window.location='signin.php';</script>";
				exit;
            }
        }else{
            /*$error_message[]  = "Invalid or expired verification code. you are being redirected to <a href='signin.php'>login</a> page within 5 second"."<script>setTimeout(function(){window.location='signin.php'},5000);</script>";
            setFlashData("error_message",$error_message);*/
			echo "<script>window.location='signin.php';</script>";
				exit;
        }
