    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div id="pad-wrapper">
                ...
                <div class="row-fluid">
                    <p class="span2 offset9"><a href="#myModal" data-backdrop="static" role="button" class="btn btn-primary" data-toggle="modal">Create Annoucement</a></p>
                </div>
                <div class="row-fluid">
                   ...
                   <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <h3 id="myModalLabel">Create New Annoucement</h3>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="post_title" required="required" class="span12" placeholder="Type Your Announcement Title">
                            </div>
                        </div>
                        <div class="control-group">
                            <!--<label class="control-label" for="input">Description</label>-->
                            <div class="controls">
                                <textarea name="post_content" required="required" class="animated span12" placeholder="Write Your Announcement Text"></textarea>
                            </div>
                        </div>
                        <div class="control-group" style="height:70px;">
                            <div class="span6">
								<label>Announcement Timestamp:</label>
                    ...
                    <button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
                     <button type="submit" name="submit" class="btn btn-primary">Create New Annoucement</button>
                    </div>
                    </form>
                    </div>
