! function(a) {
    a.fn.rating = function() {
        function b(b, c) {
            ...
            d.removeClass("icon-star-empty").addClass("icon-star"), d.prevAll("[data-value]").removeClass("icon-star-empty").addClass("icon-star"), d.nextAll("[data-value]").removeClass("icon-star").addClass("icon-star-empty")
        }

        function c(b) {
            var c = a(b);
            c.find("[data-value]").removeClass("icon-star").addClass("icon-star-empty")
        }
        ...
        for (e = this.length - 1; e >= 0; e--) {
            var f, g, h = a(this[e]),
                i = h.data("max") || 5,
                j = h.data("min") || 0,
                k = h.data("clearable") || null,
                l = "";
            for (g = j; i >= g; g++) l += ['<span class="icon icon-star-empty icon-2x" data-value="', g, '"></span>'].join("");
            k && (l += [' <a class="rating-clear" style="display:none;" href="javascript:void">', '<span class="icon icon-remove icon-2x"></span> ', k, "</a>"].join(""));
