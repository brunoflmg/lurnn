<?php
 ...
 /* Send mail to admin of site*/

// multiple recipients
$to  = 'BiggerText Support<matt@biggertexting.com>'; // note the comma
...
<html>
<head>
  <title>Support Center | lurnn.com</title>
</head>
<body>
  <p>'.$message.'</p>
  <br/>
...
// Mail it
if(mail($to, "lurnn.com|support center", $message, $headers)){
  echo "yes"; exit;
}else{
  echo "no";
}
...
<html lang="en">
  <head>
    ...
    <!-- Fav and touch icons -->
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="zion/img/sample/logo-144.png">
  ...
  <body>
              ...
              <div class="navbar-collapse">
                ...
                <div class="nav-user pull-right">
                  <ul class="nav nav-user-options">
                    <li class="signup"><a href="signup.php" class="btn btn-purple">Sign Up</a></li>
                    <li class="login"><a href="signin.php" class="btn btn-light">Login</a></li>
                  </ul>
                </div><!-- end nav-user -->
    ...
    <div class="container-wrapper">
      <div class="google-map"><iframe width="770" height="200" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.co.nz/maps?ie=UTF8&amp;cid=14812806463106713485&amp;q=Disneyland+Resort-Anaheim+Ca&amp;gl=NZ&amp;hl=en&amp;t=m&amp;z=16&amp;iwloc=near&amp;output=embed"></iframe></div>
    </div>
      ...
      <div class="row">
          ...
          <form class="form-horizontal form-contact">
            ...
            <div class="form-group">
              ...
              <div class="controls">
                <div class="row">
                  <div class="col-md-10">
                    <textarea id="inputMessage" placeholder="Your Message" class="form-control" rows="10" /></textarea>
                  </div><!-- end col -->
                </div><!-- end row -->
              </div><!-- end controls -->
            </div><!-- end form-group -->
            <div class="form-actions form-actions-no-bg">
              <button type="submit" name="submit" class="btn btn-lg btn-purple">Send Message</button>
            </div>
          </form>
        </div>
        <div class="col-md-3 sidebar">
          <div class="widget">
            ...
            <ul class="fa-ul">
              <li><i class="fa-li fa fa-map-marker"></i> <a href="#none">123 Name Street, Suburb, City</a></li>
        ...
        <div class="col-md-12">
          <div class="tile tile-horizontal">
            ...
            <div class="tile-details">
              <h3>Tile Heading</h3>
              <p>Usu ut dicit melius accumsan, quo at dolore temporibus. Ut epicuri omittantur has. Duo id rebum invidunt laboramus. Errem quaestio vis no. Tale primis facilisis has ne. Nonumes habemus pri no, mucius aliquando eu sea. Te eum omnes volumus aliquando.</p>
              <p><a href="#none" class="btn btn-inverse"><span class="fa fa-exchange"></span> Let's Go</a>&nbsp;<a href="#none" class="btn btn-success"><span class="fa fa-flask"></span> View Experiment</a></p>
            </div>
          </div><!-- end tile -->
        </div>
      </div><!-- end row -->
    ...
    <script src="zion/js/custom_checkbox_and_radio.js"></script>
    <script src="zion/js/custom_radio.js"></script>
