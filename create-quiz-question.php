<?php
    ...
    $query = sprintf("SELECT * FROM quizes WHERE creator_tid='%s'",$_SESSION['tid']);
    ...
    $sql       = "SELECT *FROM skills WHERE quiz_id = '$selected_quiz_id' AND creator_tid='".$_SESSION['tid']."'";
    $result    = mysql_query($sql);
        ...
        <div class="container-fluid">
            ...
            <div id="pad-wrapper" class="form-page">
                <div class="row-fluid form-wrapper">
					...
					<?php 
						$q_id = $_GET['quiz_id'];
						$sqlxz  = sprintf("SELECT * FROM quiz_questions_stat WHERE quiz_id='$q_id'");
						$resultxz  = mysql_query($sqlxz);
						$quiz_statxz = mysql_fetch_object($resultxz);
						
						if($quiz_stat->no_of_question <= $quiz_stat->total_asked_question)
						{
							echo "<script>window.location='class-quizzes.php';</script>";
							exit;
						}
					?>
                ...
                if(message!=""){
                    ...
                    .done(function( msg ) {
                       ...
                       if(msg=="yes")
					   {
						  ...
						  $("#ajax-modal").modal('hide');
						  window.location='create-quiz-question.php?quiz_id='+data.quiz_id;
                       }else{
                          $("#ajax-modal").modal('hide');
