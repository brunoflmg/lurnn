        ...
        <div class="container-fluid">
            ...
            <div id="pad-wrapper">
				...
				//echo "<pre>"; print_r($feed);		   
                   ...
                   <?php } ?>
						<p class="pull-right"> &nbsp; </p>
						<span style="float: right; clear: both; border-bottom: 1px solid #777; width: 82%; margin: 0px 94px 0px 0px; padding: 0px 0px 10px;">
							<a href="essayReviews.php?id=<?php echo $feed_pro->on_essay_id;?>" class="btn btn-small pull-right">
								Details
							</a>
