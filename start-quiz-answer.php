<?php
	...
	$query  = sprintf("SELECT * FROM quizes WHERE quiz_id='$quiz_id'");
    ...
    if(mysql_num_rows($result)>0){
       header("Location: self_quiz_assessment.php?id=".$quiz_id);exit;
    }*/
    ...
    if(isset($_POST['submit'])){
      ...
      if(isset($values)){
          ...
          if(mysql_query($sql)){
              ...
              mysql_query($sql);
              header("Location: show-assessment-quiz-results.php?id=".$quiz_id);exit;
          }else{
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div id="pad-wrapper">
				...
				<?php
					//--check you took this quiz before or not----------------
					$chkQuz = sprintf("SELECT * FROM quiz_answers WHERE quiz_id='$quiz_id' And student_id = '$sid'");
					$resQUZ   = mysql_query($chkQuz); 
					$QuzCount = mysql_num_rows($resQUZ);
					if($QuzCount != "0")
					{
						echo '
						<div class="alert alert-warning">
                            <strong>Warning!</strong> You have already took this quiz. Please contact to your respected teacher for another quiz.
                          </div> ';
						die();
					}
                           ...
                           <div class="offset3 span6">
                              <table class="table table-bordered">
								  ...
								  <?php
									...
									$xquery  = sprintf("SELECT * FROM classes WHERE class_id='$class_ID'");
									$xresult = mysql_query($xquery); 
									$xquiz   = mysql_fetch_object($xresult);
								  ?>
									
                                    <th>Class Name:</th>
                                    <td><?php echo $xquiz->class_name;?></td>
                                  </tr>
                                  <tr>
                                    <th>Class Code:</th>
                                    <td><?php echo $xquiz->class_code;?></td>
                                  </tr>
                                  <tr>
                                    <th>Quiz Name:</th>
                                  ...
                                  <tr>
                                    ...
                                    <td>
										<?php 
											$creater_ID = $quiz->creator_tid;
											$queryTCR  = sprintf("SELECT * FROM teachers WHERE tid = '$creater_ID'");
											$resultTCR = mysql_query($queryTCR); 
											$TCR   = mysql_fetch_object($resultTCR);
											echo $TCR->fname." ".$TCR->lname;
										?>
									</td>
                                  </tr>
                              </table>
