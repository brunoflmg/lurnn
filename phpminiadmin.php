...
@require_once("config.php");
 ...
 $ACCESS_PWD='aBcD#1234'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
   'user'=>$config["db_user"],#required
   'pwd' =>$config["db_pass"], #required
   'db'  =>$config["db_name"],  #optional, default DB
   'host'=>$config["db_host"],#optional
   'port'=>'',#optional
