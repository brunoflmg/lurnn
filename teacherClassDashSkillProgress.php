...
<head>
    ...
    <?php
		$query = "SELECT * FROM skills_grade_calculation WHERE creator_tid='$user_id' AND class_id = '$enrolled_class_id1' GROUP BY skills";
						...
						<a href="teacherGrades.php">
							...
							<span style="float:left; height:200px; overflow-y:scroll; width:100%;">
								<?php
									...
									//--- Get ESSAY----------------------------------
									$queryha  = sprintf("SELECT essays.*, essay_comments.* FROM essays LEFT JOIN essay_comments ON essays.essay_id = essay_comments.essay_id Where essays.user_id = '$tid' AND essay_comments.grade !='NULL' || essay_comments.grade !='' ORDER BY essays.essay_id DESC");
